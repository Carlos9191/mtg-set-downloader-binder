...
def download_cards_list(verify_ssl, decklist, is_from_list=False):
...
def delete_card_images():
    for images in os.listdir(r"C:\Users\Carlos Castillo III\mtg-set-dowloader-binder\art\CardsList"):
        os.remove(r"C:\Users\Carlos Castillo III\mtg-set-dowloader-binder\art\CardsList\\" + images)
...
while True:
    ...
    if option == '1':
        ...
        delete_card_images()
        decklist = input("Enter file Name exactly as it appears:")

        download_cards_list(verify_ssl, decklist, is_from_list=True)  # Download cards from a list
        break
    else:
        print("Please select 1 0r 2")
